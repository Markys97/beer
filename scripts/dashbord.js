...
$(document).ready(function(){
    ...
    // handler list-point
    $(document).on('click','.list-point__header-icon',function(e){
        e.stopPropagation()
        $(this).toggleClass('list-point__header-icon--open')
        let bodyList=  $(this).parents('.list-point__item-big').find('.list-point__body');
        $(bodyList).slideToggle('5000')
       
    })

    if($('section').hasClass('gestion-object')){
